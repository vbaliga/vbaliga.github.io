...
title: test post
---
I am using this post to modify a R Markdown template provided by the [rmarkdown](https://cran.r-project.org/web/packages/rmarkdown/index.html) package. This will be mostly futzing around so I can get familiar with how things work.  
<!---more--->
