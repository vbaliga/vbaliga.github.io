...
In my previous post (<a href="https://vbaliga.github.io/dangers-sample-variance-small-sample-size/">see here</a>), I showed that although sample variance on average gives an unbiased estimate of population variance, it is highly unreliable at extremely small sample sizes. 

This time, I will focus more closely on the <i>distributions</i> of sample variance. <b>Does sample size affect the distributions of sample variance?</b> And how might this inform how we determine which sample sizes are too small? I'll use one of my favorite new(ish) packages, <a href="https://github.com/clauswilke/ggridges">ggridges</a>, to plot the sets of distributions from one example simulation.
