...
Listed from newest to oldest original release date.

:::: indent-block
#### [statsapps](https://vbaliga.github.io/statsapps/index.html): Interactive Shiny apps to learn statistics intuitively

::: indent-block
*statsapps* includes interactive apps to help you build intuition about
various topics in data science and statistics. It is a work in progress
and (for the moment) only available on GitHub.
:::
::::
...
of inertia tensor of any flying bird. Accompanying paper ([Harvey et
al., 2022](https://doi.org/10.1038/s41586-022-04477-8)) in *Nature*.
:::
::::
...
Flydra](https://github.com/strawlab/flydra), or from other sources. Part
of the rOpenSci project (GitHub:
...
predicted data. Accompanying paper ([Baliga,
2021](https://doi.org/10.21105/joss.03074)) in the *Journal of Open
Source Software*.
:::
::::

:::: indent-block
#### [workloopR](https://github.com/ropensci/workloopR): Analysis of work loops and muscle physiology experiments

::: indent-block
*workloopR* ("work looper") provides functions for the import,
transformation, and analysis of muscle physiology experiments in R.
Accompanying paper ([Baliga and Senthivasan,
2019](https://doi.org/10.21105/joss.01856)) in the *Journal of Open
Source Software*. Part of the [rOpenSci](https://ropensci.org/) project
(GitHub: [ropensci/workloopR](https://github.com/ropensci/workloopR)).
:::
::::
