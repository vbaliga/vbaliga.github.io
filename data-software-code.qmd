...
::: indent-block
### [statsapps](https://vbaliga.github.io/statsapps/index.html): Interactive Shiny apps to help you learn concepts from data science & statistics

*statsapps* includes built-in interactive apps to help you build
intuition about various topics in data science and statistics. It is a
work in progress and (for the moment) only available on GitHub.
:::
